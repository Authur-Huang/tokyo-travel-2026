...
const prepData = [
    {
        ...
        items: [
            ...
            { id: "prep-insurance", title: "✅ 旅平險 + 不便險已投保", desc: "**已投保，這項結案。** 8 月是颱風季又是紅眼班機，**班機延誤/取消的機率明顯偏高**，不便險比旅平險更用得到 ─ 保了是對的。<br><br>**🔴 但保了不等於賠得到。** 不便險被退件最常見的原因不是沒保，是**現場沒拿到該拿的紙**。以下三件事現在做只要十分鐘，出事當下再查就來不及了。<br><br>**① 查清楚三個數字（翻保單或打客服）：**<br>‧ **延誤啟賠門檻** ─ 常見是 **4 小時或 6 小時**。不知道門檻，現場就不知道該不該繼續等、什麼時候該去櫃檯要證明<br>‧ **理賠上限與計算方式** ─ 是定額給付還是實支實付？實支實付就一定要留收據<br>‧ **保障範圍** ─ 含不含**班機取消**、**行李延誤**、**行李遺失**？三者條件常常不一樣<br><br>**② 保單號碼與 24 小時服務專線，做兩件事：**<br>‧ **截圖存進相簿**（不要只留在 email ─ 沒網路時打不開）<br>‧ **填進本頁「緊急聯絡」那張卡的「旅平險／不便險 24 小時理賠專線」欄位** ─ 填了會自動儲存並**同步到全家的手機**，四個人都查得到<br><br>**③ 確認申請時效** ─ 多數保單要求**返國後一定期間內**提出，回台灣容易忘，先知道期限。<br><br>**⚠️ 出事當下最容易漏掉的三張紙：**<br>‧ **遲延証明書（遅延証明書）** ─ 班機延誤時**向櫃檯索取**。沒有這張，延誤理賠幾乎一定被退。詳見「備案作戰室」的班機延誤卡<br>‧ **收據正本** ─ 延誤期間的餐費、交通、住宿，實支實付型一定要正本，**當下就收好別丟**<br>‧ **PIR（行李事故報告）** ─ 行李延誤或遺失要**在機場管制區內**就填。離開航廈才發現，就補不了了" },
