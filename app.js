        ...
        activities: [
            {
                ...
                desc: "捷星日本 GK012 於 07:00 順利降落成田機場第三航廈。帶孩子辦理入境與行李提領。隨後前往第二航廈購買 Welcome Suica 卡，並買好京成電鐵 Skyliner 車票直奔秋葉原。首日因清晨剛落地未入住，早餐可在機場或抵達飯店後享用，其餘天數早餐皆在飯店內享用。<br><br>**⚠️ 入境時 Visit Japan Web 是一人一個 QR、各自過關**，沒手機的孩子用**紙本 QR**，出關前先確認他手上拿著。<br><br>**⚠️ Suica 別買錯張數（8/8 更新）：爸媽兩支手機已加值完成，一個孩子已有舊卡 ─ 現場最多只要買一張。**<br>‧ 買的是 **Welcome Suica**，**成田空港駅與空港第2ビル駅**都有專用販賣機與 JR EAST Travel Service Center，免押金。<br>‧ **現金加值 ¥1,500~2,000 就好，不要加 ¥3,000** ─ Welcome Suica **餘額不能退款**，28 天後歸零。<br>‧ 🔴 **若出發前確認舊卡是紅色的 Welcome Suica（背面印有効期限、28 天效期），那張已過期 → 現場要買兩張。**<br><br>**⚠️ 落地第一件事：幫孩子換實體上網卡。** 爸媽的 eSIM 只要開啟行動數據就通了，但孩子的手機要動手拔卡 ─ **在 T2 坐下來換，不要邊走邊換**，台灣 SIM 拔下來立刻收進夾鏈袋。<br><br>**若實體卡沒趕上宅配：T1、T2 入境大廳有 SIM 卡自動販賣機（24 小時）與電信櫃台**，買 Suica 的動線上就有，現場買一張即可。",
                cp: "紅眼抵達 ─ 買好地鐵 72 小時券搭配 Suica 使用",
                heat: "上午較涼爽",
                heatClass: "cool",
                transit: "成田 T3 步行至 T2 ➔ 搭乘京成電鐵 Skyliner 到日暮里站【刷套票的 Skyliner 券，Suica 刷不進去】 ➔ 轉 JR 山手線至秋葉原站【刷 Suica，地鐵 72 小時券不含 JR】（約 1 小時 10 分鐘）",
    ...
    5: {
        ...
        activities: [
            ...
            },
            {
                ...
                desc: "從飯店提領行李後，利用飯店的地理優勢，步行至地鐵秋葉原站搭乘日比谷線直達上野，並轉乘京成電鐵 Skyliner 直達成田機場。Skyliner 全車對號且有冷氣，適合玩了一整天、拖著戰利品的疲憊家人休息。<br><br>**🔴 這一段地鐵券很可能已經過期，要刷 Suica。**<br>地鐵券是 **72 小時制**：8/12 早上啟用 → **8/15 早上就失效**，而這段是 8/15 傍晚。<br>秋葉原→上野只要 ¥180，錢不是問題，**問題是餘額見底就進不了閘門**，而你們趕的是 22:40 的班機。<br><br>**➔ 今天早上出門前，四個人各看一次 Suica 餘額，低於 ¥500 就在便利商店補。**<br>手機用信用卡加、實體卡用現金加，兩分鐘的事。<br><br>（若 8/12 是中午過後才第一次進地鐵閘門，傍晚可能還在效期內 ─ **但別賭這個**，餘額留著就沒事。）",
