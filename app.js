        ...
        activities: [
            {
                ...
                desc: "捷星日本 GK012 於 07:00 順利降落成田機場第三航廈。帶孩子辦理入境與行李提領。隨後前往第二航廈購買 Welcome Suica 卡，並買好京成電鐵 Skyliner 車票直奔秋葉原。首日因清晨剛落地未入住，早餐可在機場或抵達飯店後享用，其餘天數早餐皆在飯店內享用。<br><br>**⚠️ 入境時 Visit Japan Web 是一人一個 QR、各自過關**，沒手機的孩子用**紙本 QR**，出關前先確認他手上拿著。<br><br>**⚠️ Suica 別買錯張數：**沒手機的孩子沒有 Apple Pay，**一定要幫他買一張實體 Welcome Suica 並現金加值 ¥3,000**；其餘三人用手機綁定即可。<br><br>**⚠️ 落地第一件事：幫孩子換實體上網卡。** 爸媽的 eSIM 只要開啟行動數據就通了，但孩子的手機要動手拔卡 ─ **在 T2 坐下來換，不要邊走邊換**，台灣 SIM 拔下來立刻收進夾鏈袋。<br><br>**若實體卡沒趕上宅配：T1、T2 入境大廳有 SIM 卡自動販賣機（24 小時）與電信櫃台**，買 Suica 的動線上就有，現場買一張即可。",
...
const prepData = [
    {
        ...
        tone: "urgent",
        items: [
            { id: "prep-sim", title: "✅ 上網方案已下單：eSIM ×2 ＋ 實體上網卡 ×1（實體卡 8/8 到貨）", desc: "**已確認：① 四個人只有三支手機**（爸、媽、其中一個孩子；另一個孩子沒有且不補機）；**② 有手機的那個孩子，手機不支援 eSIM**，只能用實體上網卡。<br><br>**✅ 已下單：爸媽 2 張 eSIM ＋ 孩子 1 張實體卡，實體卡 8/8（六）到貨。**<br><br>**🔴 到貨當天（8/8）立刻插一次測試 ─ 這件事不能拖到 8/10。**<br>8/8 是週六，萬一卡有問題，**只剩 8/9（日）與 8/10（出發當天）能補救**，越晚發現越沒救。到貨當天花三分鐘測完，這條風險就結案了。<br><br>**測什麼（在台灣測，插進孩子那支手機）：**<br>① **尺寸對不對** ─ 應該是 nano-SIM，拿到 micro 就插不進去<br>② **卡槽讀不讀得到** ─ 手機有沒有反應（**顯示「無服務」是正常的**，日本的卡在台灣本來就收不到訊號，看的是手機有沒有偵測到卡片）<br>③ **Android 要不要手動設 APN** ─ 趁在台灣有網路，把商品頁的 APN 設定步驟**截圖存進相簿**，落地才不會沒網路查不到<br><br>**⚠️ 測完把台灣 SIM 裝回去。** 出發前還要用台灣門號收簡訊（刷卡報備、訂位確認、銀行 OTP），**真正換卡是落地成田才做**。<br><br>**落地換卡要帶的兩樣（放爸爸隨身包，不可託運）：**<br>① **取卡針**（迴紋針掰直也行）<br>② **空的小夾鏈袋** ─ 拔下的台灣 SIM 立刻收進去跟護照放一起。那張卡比指甲還小，掉在飯店地毯上就找不到，回台灣沒卡可插<br><br>**⚠️ 換卡後台灣門號收不到電話與簡訊**（含銀行 OTP）─ 所有需要簡訊驗證的事都要在**換卡前**做完。<br><br>**⚠️ 不要賭「用爸爸手機開熱點就好」** ─ 分流時熱點跟著爸爸走，孩子那支就斷了。<br><br>**萬一 8/8 沒收到卡，或測出來是瑕疵品：** 不要慌也不要硬等 ─ Day 1 在**成田機場買**。T1、T2 入境大廳有 **SIM 卡自動販賣機（24 小時）**與電信櫃台，你們本來就要從 T3 走到 T2 買 Suica，順路。價格貴一點但一定買得到。<br><br>**eSIM 兩張的注意事項：**<br>① **QR Code 只能掃一次，掃錯手機就報銷** ─ 先標清楚哪張是爸爸、哪張是媽媽<br>② **安裝要在台灣有 Wi-Fi 時做完**，但別提前啟用 ─ 8/10 在家裝好、行動數據先關掉，落地成田再打開<br><br>**媽媽那支是單點故障：** 分流時媽媽那組只有一支手機，沒電或掉了就完全聯絡不上。**媽媽的行動電源要單獨帶一顆，不要跟爸爸共用。**<br><br>**流量：** 每份抓 3GB 總量型就夠（導航＋LINE＋位置分享，一天約 300–500MB，飯店有 WiFi）。" },
            ...
            { id: "prep-insurance", title: "🔴 旅平險＋不便險已投保（國泰世紀產物）─ 但要先確認三件事", desc: "已投保**國泰世紀產物「旅綜合保險」Z10 方案**。8 月是颱風季又是紅眼班機，不便險比旅平險更用得到 ─ 保了是對的。<br><br>**🔴 ① 最重要：確認保費已經繳了。**<br>繳費單上**白紙黑字寫著「若繳費期限未能完成繳費者，則本次投保無效」**。<br>‧ 保費 **NT$6,764**<br>‧ **繳費期限：超商／ATM 等代收機構 8/10 24:00 前；官網 8/11 00:00 前**<br>‧ 生效日 **8/11 00:00**<br>**沒繳費 = 沒有保險。** 繳完把繳費證明也拍照存相簿。查詢繳費狀況：**0800-212-880**。<br><br>**🔴 ② 確認四個人都保到了。**<br>繳費單上的被保險人只列了一個名字。**旅平險是一人一張保單**，要確認太太與兩個孩子是否也各自投保（或這是一張四人的家庭件）。<br>**只有一個人有保 = 另外三個人在日本出事完全沒有保障**，這是現在最該打電話問清楚的一件事。<br><br>**🟡 ③ 去機場的路上還沒生效。**<br>保單 **8/11 00:00 才生效**，但你們 **8/10 晚上就要出門搭機捷**。這段路（約 22:00~24:00）不在保障範圍內。金額不大不必補保，但**知道這件事**，路上小心。<br><br>---<br><br>**📋 這張保單實際賠什麼（Z10 方案重點）**<br><br>**班機延誤 ─ 門檻已確認是 4 小時：**<br>‧ **定額給付：每滿 4 小時 3,000 元，每次最高 6,000 元**（也就是延誤滿 8 小時就封頂）<br>‧ **定額給付不需要收據**，但**一定要「遲延証明書」**<br>‧ ⚠️ 保障表上另有一列「班機延誤費用 2 萬」，與定額那列**條件可能不同**（一為實支實付上限、一為定額），**出發前打客服問清楚哪一條適用**<br><br>**其他和你們高度相關的：**<br>‧ **旅程取消 12 萬**／**旅程更改 12 萬** ← 颱風打亂行程時最用得到<br>‧ **行李延誤 6,000 元**、**行李損失 6,000 元**（另有 1 萬的列，同樣要問清楚）<br>‧ **旅行文件損失 1 萬** ← 護照掉了的補辦費用<br>‧ **改降非原定機場 6,000 元**、**食品中毒 6,000 元**、**現金竊盜 3,000 元**、**信用卡盜用 6 萬**<br>‧ **海外突發疾病：住院 350 萬／門診 1.75 萬／急診 3.5 萬**（乙型）<br>‧ **傷害醫療實支實付 350 萬** ← **實支實付＝一定要留收據正本**<br><br>---<br><br>**⚠️ 出事當下最容易漏掉的三張紙：**<br>‧ **遲延証明書（遅延証明書）** ─ 班機延誤時**向櫃檯索取**。沒有這張，延誤理賠幾乎一定被退。詳見「備案作戰室」的班機延誤卡<br>‧ **收據正本** ─ 醫療與實支實付項目一定要正本，**當下就收好別丟**<br>‧ **PIR（行李事故報告）** ─ 行李延誤或遺失要**在機場管制區內**就填。離開航廈才發現就補不了了<br><br>**還缺一個號碼：24 小時海外急難救助專線。** 繳費單上那支 0800 是繳費查詢用的，**不是**出事時打的。翻保單條款或打客服問到之後，**填進本頁「緊急聯絡」卡的欄位** ─ 填了會同步到全家手機。<br><br>**⚠️ 保單號碼、身分證字號這類個資請只填在自己手機的欄位裡，不要寫進會公開的地方。**" },
    ...
    },
    {
        ...
        items: [
            ...
            { id: "prep-charge", title: "所有裝置充飽 + Suica 先加值", desc: "手機、行動電源、相機全部充滿。**有手機的三個人先在 Apple Pay 把 Welcome Suica 加值 ¥3,000**，落地就能直接感應搭車。<br><br>**⚠️ 沒手機的孩子沒有 Apple Pay**，他的 Suica 要在成田第二航廈買**實體 Welcome Suica 卡**、用現金加值 ¥3,000 ─ 這一步已排在 Day 1 買 Suica 的動線裡，別漏掉他那張。" },
