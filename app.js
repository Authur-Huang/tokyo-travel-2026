...
const prepData = [
    ...
    },
    {
        ...
        items: [
            ...
            { id: "prep-cash", title: "換日幣 ¥80,000 ~ ¥100,000（已換 ¥30,000，尚缺 ¥50,000~70,000）", desc: "銀行換匯比機場划算。**分兩批換、分兩個包放**，爸媽各帶一半。<br><br>**⚠️ 銀行只剩三個營業日：8/6(四)、8/7(五)、8/10(一)** ─ 8/8、8/9 是週末關門，而 8/10 已是出發當天。<br><br>**大額現鈔多數分行要預約、隔 1~2 個工作日**，所以**要在 8/6 就去問**，才留得下 8/7 或 8/10 取鈔的空間。拖到 8/7 才問，就只剩 8/10 一天可取，而那天晚上就要出門了。" },
