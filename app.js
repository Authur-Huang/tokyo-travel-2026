...
const itineraryData = {
    1: {
        ...
        activities: [
            {
                time: "07:00 - 09:35",
                title: "抵達成田 T3 → 移動到 T2 車站領票",
                desc: "捷星日本 GK012 於 07:00 降落成田機場**第三航廈**。首日清晨落地尚未入住，早餐在機場或抵達飯店後享用。<br><br>**📍 京成套票取票櫃檯：機場第2航廈站（成田第2•3航廈），07:00–21:00。**<br>成田三個航廈是三棟分開的建築，**T3 沒有車站** ─ 最近的是 **空港第2ビル駅（T2）**，它同時服務 T2 與 T3，就是你們該去的站。<br>✅ **去程在這站上車、回程也在這站下車，整趟只要記一個站名。**<br><br>**🚌 T3 → T2：兩種走法，都不遠**<br>‧ **免費直通接駁巴士，車程約 3 分鐘**（班次密，出關後跟著「Terminal 2 / 連絡バス」指標走）← 建議這個，帶四個大行李箱最省力<br>‧ 或走 **630 公尺的連絡通道，約 15 分鐘**（有遮蔽，巴士排隊太長時的備案）<br><br>⚠️ **不要跑去 T1（成田空港駅）** ─ 那是另一個航廈、另一個車站，多花 10 分鐘。<br><br>**⚠️ 入境時 Visit Japan Web 是一人一個 QR、各自過關**，沒手機的孩子用**紙本 QR**，出關前先確認他手上拿著。<br><br>**⚠️ Suica 別買錯張數（8/8 更新）：爸媽兩支手機已加值完成，一個孩子已有舊卡 ─ 現場最多只要買一張。**<br>‧ 買的是 **Welcome Suica**，**空港第2ビル駅（T2，就是你們領票的同一個車站）**有專用販賣機與 JR EAST Travel Service Center，免押金。<br>‧ **現金加值 ¥1,500~2,000 就好，不要加 ¥3,000** ─ Welcome Suica **餘額不能退款**，28 天後歸零。<br>‧ 🔴 **若出發前確認舊卡是紅色的 Welcome Suica（背面印有効期限、28 天效期），那張已過期 → 現場要買兩張。**<br><br>**⚠️ 幫孩子換實體上網卡。** 爸媽的 eSIM 只要開啟行動數據就通了，但孩子的手機要動手拔卡 ─ **在 T2 車站坐下來換，不要邊走邊換**，台灣 SIM 拔下來立刻收進夾鏈袋。<br><br>**若實體卡出問題：T2 入境大廳有 SIM 卡自動販賣機（24 小時）與電信櫃台**，就在動線上，現場買一張即可。<br><br>---<br><br>**📋 到了 T2 車站（空港第2ビル駅），三件事一次做完：**<br><br>**① 先領 Skyliner 套票** ← 一定先做這個<br>Skyliner 自動售票機或**Skyliner ＆京成 Information Center**（07:00–21:00）。會拿到**兩張東西**：<br>‧ **Skyliner 車票**（去回程各一）<br>‧ **東京地鐵 72 小時券**<br>🔴 **Skyliner 是全車指定席** ─ 領票時就要選班次與座位。**四個人要坐在一起，這時候就要講**，不要上車才發現分散。<br>★ **刻意選一班 40~50 分鐘後的車**，剩下的時間拿來做②③、上廁所、買早餐，從容上車。<br><br>**② 買孩子的 Welcome Suica**（同一層，現金加值 ¥1,500~2,000）<br><br>**③ 坐下來換孩子的上網卡**<br><br>---<br><br>**🎫 今天的票券規則（最容易搞混，先看清楚）**<br><br>| 這一段 | 刷什麼 |<br>| --- | --- |<br>| Skyliner（成田→日暮里） | **Skyliner 車票** |<br>| 日暮里 → 秋葉原 | 🔴 **Suica**（這是 JR，**地鐵券不能用**） |<br><br>🔴 **東京地鐵 72 小時券今天不要啟用！** 領到手先收好，忍到 **8/12 早上**第一次進地鐵閘門再用 ─ 它是「72 小時」不是「3 天」，今天開卡等於白白浪費一整天。",
                cp: "動線最短 ─ 接駁巴士 3 分鐘到 T2，三件事在同一站做完，去回程同一站",
                heat: "上午較涼爽",
                heatClass: "cool",
                transit: "T3 出關 ➔ **免費直通接駁巴士到 T2（車程約 3 分）** ➔ 空港第2ビル駅 領票／買 Suica／換 SIM ➔ **Skyliner 至日暮里（約 38 分）** ➔ 轉 **JR 山手線**至秋葉原（4 站約 6 分，**刷 Suica**）➔ 步行 6 分鐘到飯店寄行李",
    ...
    5: {
        ...
        activities: [
            ...
            },
            {
                ...
                desc: "從飯店提領行李後，利用飯店的地理優勢，步行至地鐵秋葉原站搭乘日比谷線直達上野，並轉乘京成電鐵 Skyliner 直達成田機場。Skyliner 全車對號且有冷氣，適合玩了一整天、拖著戰利品的疲憊家人休息。<br><br>**🔴 在「空港第2ビル」下車 ─ 就是你們 Day 1 抵達時上車的那一站。**<br>GK011 從 **T3** 起飛，最近的車站是 **空港第2ビル（T2）**，那是終點站的**前一站**。<br>✅ **好記法：回到你們來的那一站。** 去程回程同一站，不用記兩個名字。<br>⚠️ 但還是**設個鬧鐘** ─ 玩了一整天又要搭紅眼班機，坐過頭到終點（成田空港／T1）就得折返，而那天趕的是 22:40 的班機。<br>下車後從 T2 到 T3：**免費接駁巴士約 3 分鐘**，或走 630 公尺連絡通道約 15 分鐘。<br><br>**🔴 這一段地鐵券很可能已經過期，要刷 Suica。**<br>地鐵券是 **72 小時制**：8/12 早上啟用 → **8/15 早上就失效**，而這段是 8/15 傍晚。<br>秋葉原→上野只要 ¥180，錢不是問題，**問題是餘額見底就進不了閘門**，而你們趕的是 22:40 的班機。<br><br>**➔ 今天早上出門前，四個人各看一次 Suica 餘額，低於 ¥500 就在便利商店補。**<br>手機用信用卡加、實體卡用現金加，兩分鐘的事。<br><br>（若 8/12 是中午過後才第一次進地鐵閘門，傍晚可能還在效期內 ─ **但別賭這個**，餘額留著就沒事。）",
                cp: "極速交通 ─ 利用日比谷線 3 分鐘轉乘 Skyliner，省時省力",
                heat: "車廂內冷氣",
                heatClass: "cool",
                transit: "從飯店步行 6 分鐘 ➔ 地鐵秋葉原站搭乘日比谷線（2站，3分鐘）➔ 上野站 ➔ 轉乘京成 Skyliner ➔ 🔴 **在「空港第2ビル」下車 ─ 就是 Day 1 上車的那一站**（**不是**坐到終點成田空港／T1）➔ 搭 3 分鐘接駁巴士或走 15 分鐘到第三航廈報到",
...
const prepData = [
    ...
    },
    {
        ...
        items: [
            ...
            { id: "prep-map", title: "Google Maps 下載東京離線地圖（三支手機都要）", desc: "🔴 **先搞清楚它不能做什麼，否則會在最需要時誤判：**<br>**離線地圖只支援「駕車導航」。沒網路時，大眾運輸（電車）、步行、單車路線通通查不了。**<br><br>它救得了你的是「**我現在在哪**」「**那家店在哪個方向**」；<br>救不了你的是「**我要怎麼搭電車回飯店**」。<br>➔ 所以它**不能取代**離線急救卡，兩個都要有。<br><br>**📥 怎麼下載**<br>Google Maps → 右上角**自己的頭像** → **離線地圖** → **選取自己的地圖** → 兩指縮放框住範圍 → **下載**<br><br>**範圍**：以東京為中心，北到淺草上野、南到東京鐵塔、西到澀谷代官山、東到秋葉原銀座。<br>⚠️ **成田機場不用勉強框進去**（太遠，框太大會被拒絕；機場有免費 WiFi）。<br>⚠️ 大約 **200~500 MB**，**先確認手機空間**，**用家裡 WiFi 下載**。<br><br>**🔴 下載完一定要實測：把手機開飛航模式，再搜「浅草寺」。**<br>畫得出地圖 ＝ 成功；一片灰或轉圈圈 ＝ 沒下載成功，重來。<br>**沒測過的離線地圖等於沒有離線地圖。**<br><br>**⭐ 順便把這些存進「已儲存」清單**（走散時要去的地方最重要）：<br>‧ **飯店** THE TOURIST HOTEL & Cafe AKIHABARA（台東1-6-6）<br>‧ **空港第2ビル駅**（去程上車、回程下車都是這站）<br>‧ **台北駐日經濟文化代表處**（港区白金台5-20-2，護照掉了要去）<br>‧ **四個會合點**：MUJI 銀座／東京 Midtown 星巴克／Niko and... TOKYO／MEGA 唐吉訶德 澀谷本店<br><br>**⚠️ 因為離線查不到電車，改成這樣做：每天早上趁飯店 WiFi 把當天路線查好並截圖存相簿** ─ 截圖不需要網路。" },
